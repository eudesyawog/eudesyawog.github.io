...
<center>
<div id="main">
<form id="formulaire"  method="post" action="index.php?page=formulaire/formulaire_photo" enctype="multipart/form-data"> 
<fieldset>
...
{
?>
           <option value="<?php echo $donnees['ID_PJ']; ?>"><?php echo $donnees['PRENOM_PJ'].' '.$donnees['NOM_PJ']; ?></option>
<?php
}
$reponse->closeCursor(); 
?>
...
<input type="text" name="titre"> <br/> <br/>
 ...
 <fieldset>
 <legend style="text-align : center; color:Tomato; font-size: 24; "> Géolocalisation de la photographie </legend> <br/> <br />
 <p style="color:Tomato; font-family: verdana; font-size: 12;">
Utiliser le bouton géolocaliser pour chercher les informations
</p>
* Adresse en français :  <input type="text" name="adresse_fr" id="adresse_fr" placeholder="Ex : Rue Ponciano Arriaga. A l’angle de la Plaza de la Republica" maxlength="128" required />
<p id="compteur"></p> 
...
* Adresse en espagnol : <input type="text" name="adresse_es" id="adresse_es" placeholder="Ex : Calle Ponciano Arriaga. En la esquina de Plaza de la República" maxlength="128" required />
<p id="compteur2"></p> 
<script type="text/javascript">
...
<br />
<br />
* Longitude : <input type="number_format" name="longitude" id="longitude" value="" size="15" required />
* Latitude : <input type="number_format" name="latitude" id="latitude" value="" size="15" required /> <br/> <br/>
<div id="map"></div>
<script type="text/javascript">
function initMap() {
var myOptions = {
...
<input type="url" name="streetview" id="streetview" placeholder="Ex :https://www.google.com/maps/@19.3943,-99.1461436,3..." >
<br /><br />
<input type="button" onclick="geolocalise()" value="géolocaliser" />
</fieldset> <br /><br />
<fieldset>
<legend style="text-align : center; color:Tomato; font-size: 24; " > Description de la photo : </legend>
 <label for="DESCRIPTION_FR">* Description de la photo en français : </label>
 <textarea type="text" name="DESCRIPTION_FR" id="DESCRIPTION_FR"   rows="10" cols="50"  required ></textarea> 
 <br />
 <br />
 <label for="DESCRIPTION_ES">* Descripción de la foto en español :</label>
 <textarea type="text" name="DESCRIPTION_ES" id="DESCRIPTION_ES"   rows="10" cols="50" required></textarea>
</fieldset> <br/> 
<fieldset> 
<legend style="text-align : center; color:Tomato; font-size: 24;"> Autre information sur la photo : </legend> <br/> <br/>
...
<input type="number" name="ordre" id="ordre" min="1" placeholder="Ex : 1 ou 2 ou 3 ou 4...." >
<br /><br />
<label for="date_photo"> Date de la photo : </label>
<input type="text" name="date_photo" id="date_photo" value="1985-09-19"  placeholder="Ex : 1985-09-19" >
<script>
$( function() {
...
<input type="number" name="angle" id="angle" min="0" max="360"  placeholder="Ex : 90" >
</fieldset>
<p style="color:Tomato; font-family: verdana;">
Les champs avec une * sont obligatoires
</p>
<input type="submit" name="envoyer" value="Ajouter photo" />   
</p>
</form>
<script type="text/javascript">
					...
					{							
						...
						{	
							...
							if($photo['mime'] == $ListeExtension[$ExtensionPresumee]  || $photo['mime'] == $ListeExtensionIE[$ExtensionPresumee])
							{
								...
								include ('connexion_bd.php');
								$sql="INSERT INTO photo(ID_PJ,REPERTOIRE,NOM_PHOTO,TITRE,LONGITUDE,LATITUDE,DESCRIPTION_FR,DESCRIPTION_ES,ADRESSE_FR,ADRESSE_ES,PRECISIONLOC,ORDRE,DATE_PHOTO,STREET_VIEW,ANGLE_VUE)
									  VALUES(:id_pj,:repertoire,:nom_photo,:titre,:longitude,:latitude,:description_fr,:description_es,:adresse_fr,:adresse_es,:precision_loc,:ordre,:date_photo,:street_view,:angle_vue)";
